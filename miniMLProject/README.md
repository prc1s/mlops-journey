...
This project uses [DVC](https://dvc.org/) for data versioning and is hosted on:

- Code: [GitHub Repository](https://github.com/prc1s/miniMLProject)
- Data & Experiment Tracking: [DagsHub Project](https://dagshub.com/prc1s/miniMLProject)
...
### Project: Data Pipeline with DVC and MLflow for Machine Learning -Details
